        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-bold text-slate-900 tracking-tight mb-8">
              Find the perfect{" "}
              <span className="text-indigo-600">freelance services</span> for
              your business
            </h1>
            <p className="text-lg md:text-xl text-slate-500 mb-10 max-w-2xl mx-auto leading-relaxed">
              Connect with talented freelancers to get your projects done.
              Secure payments, professional quality, and timely delivery.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-lg mx-auto">
              <Link href="/gigs">
                <Button
                  size="lg"
                  className="w-full sm:w-auto h-12 px-8 bg-indigo-600 hover:bg-indigo-700 text-lg shadow-lg shadow-indigo-500/30"
                >
                  Find Work
                </Button>
              </Link>
              <Link href="/gigs/new">
                <Button
                  size="lg"
                  variant="outline"
                  className="w-full sm:w-auto h-12 px-8 text-lg border-2 hover:bg-slate-50"
                >
                  Post a Gig
                </Button>
              </Link>
            ...
            {[
              {
                icon: Zap,
                title: "Fast Delivery",
                desc: "Get your work done quickly with our verified talent pool.",
              },
              {
                icon: Shield,
                title: "Secure Payments",
                desc: "Your money is held safely until you approve the work.",
              },
              {
                icon: CheckCircle2,
                title: "Quality Assured",
                desc: "Review portfolios and ratings before hiring.",
              },
            ].map((feature, i) => (
              <div
                key={i}
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link href="/gigs">
              <Button
                variant="ghost"
                className="hidden sm:flex group text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50"
              >
                View all gigs{" "}
